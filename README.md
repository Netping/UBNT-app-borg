...
~~~~~~~~~~~~~~~~~~~~~~~~~
borg-linux64        Linux 64bit (built on Debian 9 "Stretch" with glibc 2.24)
                    Note: you can also try them on other older Linuxes - as
                    long as the glibc is compatible, they will work.
borg-macosx64       Mac OS X (Darwin) 64bit (built on OS X Sierra 10.12
                    with latest FUSE from brew, requires >= 10.12)
borg-freebsd64      FreeBSD 64bit (built on FreeBSD 12.1)
